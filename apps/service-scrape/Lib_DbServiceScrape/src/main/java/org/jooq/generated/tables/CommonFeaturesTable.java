...
public class CommonFeaturesTable extends TableImpl<CommonFeaturesTableRecord> {
     ...
     */
    public final TableField<CommonFeaturesTableRecord, Short> ID = createField(DSL.name("id"), SQLDataType.SMALLINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>public.common_features_table.bed_quantity</code>.
     */
    public final TableField<CommonFeaturesTableRecord, Short> BED_QUANTITY = createField(DSL.name("bed_quantity"), SQLDataType.SMALLINT.nullable(false), this, "");

    /**
     * The column <code>public.common_features_table.bath_quantity</code>.
     */
    public final TableField<CommonFeaturesTableRecord, Short> BATH_QUANTITY = createField(DSL.name("bath_quantity"), SQLDataType.SMALLINT.nullable(false), this, "");

    /**
     * The column <code>public.common_features_table.car_quantity</code>.
     */
    public final TableField<CommonFeaturesTableRecord, Short> CAR_QUANTITY = createField(DSL.name("car_quantity"), SQLDataType.SMALLINT.nullable(false), this, "");

    /**
     * The column <code>public.common_features_table.home_type</code>.
     */
    public final TableField<CommonFeaturesTableRecord, HomeTypeEnum> HOME_TYPE = createField(DSL.name("home_type"), SQLDataType.VARCHAR.nullable(false).asEnumDataType(HomeTypeEnum.class), this, "");

    /**
     * The column <code>public.common_features_table.is_retirement</code>.
     */
    public final TableField<CommonFeaturesTableRecord, Boolean> IS_RETIREMENT = createField(DSL.name("is_retirement"), SQLDataType.BOOLEAN.nullable(false), this, "");

    private CommonFeaturesTable(Name alias, Table<CommonFeaturesTableRecord> aliased) {
        this(alias, aliased, (Field<?>[]) null, null);
    }

    private CommonFeaturesTable(Name alias, Table<CommonFeaturesTableRecord> aliased, Field<?>[] parameters, Condition where) {
    ...
    public <O extends Record> CommonFeaturesTable(Table<O> path, ForeignKey<O, CommonFeaturesTableRecord> childPath, InverseForeignKey<O, CommonFeaturesTableRecord> parentPath) {
    ...
    public static class CommonFeaturesTablePath extends CommonFeaturesTable implements Path<CommonFeaturesTableRecord> {
        ...
        private static final long serialVersionUID = 1L;
        public <O extends Record> CommonFeaturesTablePath(Table<O> path, ForeignKey<O, CommonFeaturesTableRecord> childPath, InverseForeignKey<O, CommonFeaturesTableRecord> parentPath) {
    ...
    public HomeTablePath homeTable() {
        if (_homeTable == null)
            _homeTable = new HomeTablePath(this, null, Keys.HOME_TABLE__HOME_TABLE_COMMON_FEATURES_TABLE_ID_COMMON_FEATURES_TABLE_ID_FK.getInverseKey());
    ...
    public List<Check<CommonFeaturesTableRecord>> getChecks() {
        return Arrays.asList(
            Internal.createCheck(this, DSL.name("common_features_table_bath_quantity_check"), "(((bath_quantity >= 0) AND (bath_quantity <= 5)))", true),
            Internal.createCheck(this, DSL.name("common_features_table_bed_quantity_check"), "(((bed_quantity >= 0) AND (bed_quantity <= 5)))", true),
            Internal.createCheck(this, DSL.name("common_features_table_car_quantity_check"), "(((car_quantity >= 0) AND (car_quantity <= 5)))", true)
        );
    }
