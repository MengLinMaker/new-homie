...
public class LocalitiesTable extends TableImpl<LocalitiesTableRecord> {
     ...
     */
    public final TableField<LocalitiesTableRecord, String> SUBURB_NAME =
            createField(DSL.name("suburb_name"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.localities_table.postcode</code>.
     */
    public final TableField<LocalitiesTableRecord, String> POSTCODE =
     ...
     */
    public final TableField<LocalitiesTableRecord, StateAbbreviationEnum> STATE_ABBREVIATION = createField(
            DSL.name("state_abbreviation"),
            SQLDataType.VARCHAR.nullable(false).asEnumDataType(StateAbbreviationEnum.class),
            this,
            "");
    ...
    public <O extends Record> LocalitiesTable(
            Table<O> path,
            ForeignKey<O, LocalitiesTableRecord> childPath,
            InverseForeignKey<O, LocalitiesTableRecord> parentPath) {
    ...
    public static class LocalitiesTablePath extends LocalitiesTable implements Path<LocalitiesTableRecord> {
        ...
        public <O extends Record> LocalitiesTablePath(
                Table<O> path,
                ForeignKey<O, LocalitiesTableRecord> childPath,
                InverseForeignKey<O, LocalitiesTableRecord> parentPath) {
    ...
    public HomeTablePath homeTable() {
        if (_homeTable == null)
            _homeTable = new HomeTablePath(
                    this, null, Keys.HOME_TABLE__HOME_TABLE_LOCALITIES_TABLE_ID_LOCALITIES_TABLE_ID_FK.getInverseKey());
    ...
    public List<Check<LocalitiesTableRecord>> getChecks() {
        return Arrays.asList(
                Internal.createCheck(
                        this, DSL.name("localities_table_postcode_check"), "((length(postcode) = 4))", true),
                Internal.createCheck(
                        this, DSL.name("localities_table_suburb_name_check"), "((length(suburb_name) < 64))", true));
    }
