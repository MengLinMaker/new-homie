...
public class HomeTable extends TableImpl<HomeTableRecord> {
     ...
     */
    public final TableField<HomeTableRecord, Integer> ID = createField(DSL.name("id"), SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>public.home_table.localities_table_id</code>.
     */
    public final TableField<HomeTableRecord, Short> LOCALITIES_TABLE_ID = createField(DSL.name("localities_table_id"), SQLDataType.SMALLINT, this, "");

    /**
     * The column <code>public.home_table.common_features_table_id</code>.
     */
    public final TableField<HomeTableRecord, Short> COMMON_FEATURES_TABLE_ID = createField(DSL.name("common_features_table_id"), SQLDataType.SMALLINT, this, "");

    /**
     * The column <code>public.home_table.street_address</code>.
     */
    public final TableField<HomeTableRecord, String> STREET_ADDRESS = createField(DSL.name("street_address"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.home_table.gps</code>.
     */
    public final TableField<HomeTableRecord, Geometry> GPS = createField(DSL.name("gps"), SQLDataType.GEOMETRY.nullable(false), this, "");

    /**
     * The column <code>public.home_table.land_m2</code>.
     */
    public final TableField<HomeTableRecord, Short> LAND_M2 = createField(DSL.name("land_m2"), SQLDataType.SMALLINT, this, "");

    /**
     * The column <code>public.home_table.inspection_time</code>.
     */
    public final TableField<HomeTableRecord, LocalTime> INSPECTION_TIME = createField(DSL.name("inspection_time"), SQLDataType.LOCALTIME(6), this, "");

    /**
     * The column <code>public.home_table.auction_time</code>.
     */
    public final TableField<HomeTableRecord, LocalTime> AUCTION_TIME = createField(DSL.name("auction_time"), SQLDataType.LOCALTIME(6), this, "");
    ...
    public <O extends Record> HomeTable(Table<O> path, ForeignKey<O, HomeTableRecord> childPath, InverseForeignKey<O, HomeTableRecord> parentPath) {
    ...
    public static class HomeTablePath extends HomeTable implements Path<HomeTableRecord> {
        ...
        private static final long serialVersionUID = 1L;
        public <O extends Record> HomeTablePath(Table<O> path, ForeignKey<O, HomeTableRecord> childPath, InverseForeignKey<O, HomeTableRecord> parentPath) {
    ...
    public List<ForeignKey<HomeTableRecord, ?>> getReferences() {
        return Arrays.asList(Keys.HOME_TABLE__HOME_TABLE_COMMON_FEATURES_TABLE_ID_COMMON_FEATURES_TABLE_ID_FK, Keys.HOME_TABLE__HOME_TABLE_LOCALITIES_TABLE_ID_LOCALITIES_TABLE_ID_FK);
    }
    ...
    public CommonFeaturesTablePath commonFeaturesTable() {
        if (_commonFeaturesTable == null)
            _commonFeaturesTable = new CommonFeaturesTablePath(this, Keys.HOME_TABLE__HOME_TABLE_COMMON_FEATURES_TABLE_ID_COMMON_FEATURES_TABLE_ID_FK, null);
    ...
    public LocalitiesTablePath localitiesTable() {
        if (_localitiesTable == null)
            _localitiesTable = new LocalitiesTablePath(this, Keys.HOME_TABLE__HOME_TABLE_LOCALITIES_TABLE_ID_LOCALITIES_TABLE_ID_FK, null);
    ...
    public RentPriceTablePath rentPriceTable() {
        if (_rentPriceTable == null)
            _rentPriceTable = new RentPriceTablePath(this, null, Keys.RENT_PRICE_TABLE__RENT_PRICE_TABLE_HOME_TABLE_ID_HOME_TABLE_ID_FK.getInverseKey());
    ...
    public SalePriceTablePath salePriceTable() {
        if (_salePriceTable == null)
            _salePriceTable = new SalePriceTablePath(this, null, Keys.SALE_PRICE_TABLE__SALE_PRICE_TABLE_HOME_TABLE_ID_HOME_TABLE_ID_FK.getInverseKey());
    ...
    public List<Check<HomeTableRecord>> getChecks() {
        return Arrays.asList(
            Internal.createCheck(this, DSL.name("home_table_street_address_check"), "((length(street_address) < 64))", true)
        );
    }
