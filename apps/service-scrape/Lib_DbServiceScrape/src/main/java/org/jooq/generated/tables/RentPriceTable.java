...
public class RentPriceTable extends TableImpl<RentPriceTableRecord> {
     ...
     */
    public final TableField<RentPriceTableRecord, Integer> ID = createField(DSL.name("id"), SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>public.rent_price_table.home_table_id</code>.
     */
    public final TableField<RentPriceTableRecord, Integer> HOME_TABLE_ID = createField(DSL.name("home_table_id"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>public.rent_price_table.first_scrape_date</code>.
     */
    public final TableField<RentPriceTableRecord, LocalDate> FIRST_SCRAPE_DATE = createField(DSL.name("first_scrape_date"), SQLDataType.LOCALDATE.nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.LOCALDATE)), this, "");

    /**
     * The column <code>public.rent_price_table.last_scrape_date</code>.
     */
    public final TableField<RentPriceTableRecord, LocalDate> LAST_SCRAPE_DATE = createField(DSL.name("last_scrape_date"), SQLDataType.LOCALDATE.nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.LOCALDATE)), this, "");

    /**
     * The column <code>public.rent_price_table.weekly_rent_aud</code>.
     */
    public final TableField<RentPriceTableRecord, Float> WEEKLY_RENT_AUD = createField(DSL.name("weekly_rent_aud"), SQLDataType.REAL.nullable(false), this, "");

    /**
     * The column <code>public.rent_price_table.aud_per_bed</code>.
     */
    public final TableField<RentPriceTableRecord, Float> AUD_PER_BED = createField(DSL.name("aud_per_bed"), SQLDataType.REAL, this, "");

    /**
     * The column <code>public.rent_price_table.aud_per_land_m2</code>.
     */
    public final TableField<RentPriceTableRecord, Float> AUD_PER_LAND_M2 = createField(DSL.name("aud_per_land_m2"), SQLDataType.REAL, this, "");
    ...
    public <O extends Record> RentPriceTable(Table<O> path, ForeignKey<O, RentPriceTableRecord> childPath, InverseForeignKey<O, RentPriceTableRecord> parentPath) {
    ...
    public static class RentPriceTablePath extends RentPriceTable implements Path<RentPriceTableRecord> {
        ...
        private static final long serialVersionUID = 1L;
        public <O extends Record> RentPriceTablePath(Table<O> path, ForeignKey<O, RentPriceTableRecord> childPath, InverseForeignKey<O, RentPriceTableRecord> parentPath) {
    ...
    public HomeTablePath homeTable() {
        if (_homeTable == null)
            _homeTable = new HomeTablePath(this, Keys.RENT_PRICE_TABLE__RENT_PRICE_TABLE_HOME_TABLE_ID_HOME_TABLE_ID_FK, null);
